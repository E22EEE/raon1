...
var = false 
local Text = database:get(bot_id..'text:ch:user') or '* 𑁞 ╶ عذࢪا عليڪ الاشتࢪاڪ بالقناه اولاً *'
...
local raon1_Msg = ''  
if msgs < 100 then 
raon1_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
raon1_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
raon1_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
raon1_Msg = 'متفاعل' 
elseif msgs < 1200 then 
raon1_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
raon1_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
raon1_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
raon1_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
raon1_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
raon1_Msg = 'اقوى متفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function Sourceraon1(msg,data) --  رآون 
if msg then
...
send(msg.chat_id_, msg.id_,' * 𑁞 ╶ تم تحديث السورس* \n* 𑁞 ╶ لديك اخر اصدار لسورس اروآن*\n* 𑁞 ╶ الاصدار » { 2.8v} *')
dofile('raon1.lua')  
end
if text == 'الاصدار ⌯' and Devraon1W(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' * 𑁞 ╶ اصدار سورس اروآن * \n* 𑁞 ╶ الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and Devraon1W(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  𑁞 ╶ [تحديثات البوت](t.me/E22EE2) \n 𑁞 ╶ [قناه السورس](t.me/E22EE2)')
end
...
Text = "- 𝗪𝗲𝗹𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 𝗦𝗼𝘂𝗿𝗰𝗿 𝗔𝗿𝗼𝗮𝗡 -\n\n[⌯ 𝗥𝗮𝗼𝗡 . 𝗗𝗲𝗩𝗲𝗹𝗼𝗣𝗲𝗿 ⌯](http://t.me/e22eee)\n\n[⌯ 𝗥𝗮𝗼𝗡 . 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ⌯](http://t.me/E22EE2)\n\n[⌯ 𝗶𝗡𝗙𝗼 . 𝗦𝗼𝘂𝗿𝗰𝗿 ⌯](http://t.me/o22oo2)\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ - 𝗦𝗼𝘂𝗿𝗰𝗿 . 𝗔𝗿𝗼𝗮𝗡 -',url="t.me/E22EE2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/E22EE2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
if text == 'الملفات' and Devraon1W(msg) then
t = ' * 𑁞 ╶ ملفات سورس اروآن ↓*\n*𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𝗿𝗮𝗼𝗻 𐄐𐄐𐄐𐄐𐄐𐄐𐄐* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if Devraon1W(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/E22EEE/Files/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and Devraon1W(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/E22EEE/Files/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('raon1.lua')  
else
send(msg.chat_id_, msg.id_," * 𑁞 ╶ عذرا الملف لايدعم سورس اروآن* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and Devraon1W(msg) then
...
if text == "مسح الملفات" and Devraon1W(msg) then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اروآن').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اروآن')
send(msg.chat_id_, msg.id_,'*بوت بعينك اسمي '..Namebot..'* ')
end
...
Text = [[
*ꍈ اهلااً بك عزيزي انت في اوامر البوت ꍈ*
*𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𝗿𝗮𝗼𝗻 𐄐𐄐𐄐𐄐𐄐𐄐𐄐*
*⌯ م1 - اوامر الحمايه*
...
send(msg.chat_id_, msg.id_, t..'*𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𝗿𝗮𝗼𝗻 𐄐𐄐𐄐𐄐𐄐𐄐𐄐*\n 𑁞 ╶ [仒𐄐𝗥𝗮𝗼𝗡 ֊ .](t.me/E22EE2) ')
end
...
t =[[
*عمري لا تحذف خليك قوي وخذ التلي للونسه وخلي قلبك اروآن وأذا مستقبلك يجبرك فأحذف بساع 💘*
*𐄐𐄐𐄐𐄐𐄐𐄐𐄐 𝗿𝗮𝗼𝗻 𐄐𐄐𐄐𐄐𐄐𐄐𐄐*
...
local notText = ' 𑁞 ╶ هلاوامر متخصك حياتي '
...
{{text = '- 𝗦𝗼𝘂𝗿𝗰𝗿 . 𝗔𝗿𝗼𝗮𝗡 -',url='http://t.me/E22EE2'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اروآن')
